...
class TestTheSetPointIsRead:
    ...
    side effect. This is that act: `set_point` asks PHD2 every time, and a cooler
    that is off has no set point to report.
    """
    ...
    def test_a_set_point_does_not_survive_the_cooler_going_off(self):
        """The 2026-09-08 episode: 80 minutes at 16.5 degC still reporting 5.0.
